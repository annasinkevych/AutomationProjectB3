...
public class PageElementUtils {
    ...
    //object of FluentWait class that is part of Selenium
    public static FluentWait<WebDriver> wait;

    //explicit wait - Thread.sleep(10000);
     ...
     * for it to become visible on the page (ex.if there are a lot of
     * dropdown options it will scroll to the needed one
     *
     * @param element
     */
    ...
    public static void sendKeysToDropDownContainer(String containerName, String value){
        ...
        List<WebElement> options = Driver.getDriver().findElements(By.xpath("//div[@class= 'v-list-item__title']/span | //span[.='"+ value + "']")); // //span[.='"+value+"']
